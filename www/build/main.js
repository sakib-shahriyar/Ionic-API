...
var HomePage = (function () {
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], HomePage.prototype, "pass", void 0);
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"E:\Ionic\SakibShahriyarPathan\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Login Page\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n	<ion-list>\n\n		<ion-item>\n			<ion-label floating>Username</ion-label>\n			<ion-input type="text" value="" #username></ion-input>\n		</ion-item>\n\n		<ion-item>\n			<ion-label floating>Password</ion-label>\n			<ion-input type="password" value="" #password></ion-input>\n		</ion-item>\n\n	</ion-list>\n\n	<div padding>\n		<button block ion-button round icon-left color="light" (click)="login()">\n  			<ion-icon name="log-in"></ion-icon>\n  			Login\n		</button>\n	\n	</div>\n	\n</ion-content>\n'/*ion-inline-end:"E:\Ionic\SakibShahriyarPathan\src\pages\home\home.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_auth_service_auth_service__ = __webpack_require__(275);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"E:\Ionic\SakibShahriyarPathan\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"E:\Ionic\SakibShahriyarPathan\src\app\app.html"*/
        }),
...
var LoginPage = (function () {
    ...
    LoginPage.prototype.loadUser = function () {
        ...
        loader.present().then(function () {
            _this.http.get('https://randomuser.me/api/').map(function (res) { return res.json(); }).subscribe(function (res) {
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"E:\Ionic\SakibShahriyarPathan\src\pages\login\login.html"*/'<!--\n  Generated template for the LoginPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar hideBackButton="true">\n   \n    <ion-title>\n      Profile\n    </ion-title>\n\n    <ion-buttons end>\n      <button ion-button icon-only (click)="goBack()">\n        <ion-icon name="log-out"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n	<div *ngFor="let item of data">\n			<ion-item>\n				\n					<img src="{{item.picture.large}}">\n				\n				<h2> First Name: {{item.name.first}}</h2>\n				<h2> Last Name: {{item.name.last}}</h2>\n				<h2> Date of Birth: {{item.dob}}</h2>\n				<h2> Email: {{item.email}}</h2>\n				<h2> Location: {{item.location.street}}, {{item.location.city}},</h2> \n				<h2> &emsp; &emsp; &emsp; &nbsp; {{item.location.state}}, {{item.location.postcode}}</h2>\n				<h2> Phone: {{item.phone}}</h2>\n				<h2> Cell Info: {{item.cell}}</h2>\n\n			</ion-item>\n	</div>\n	<button ion-button round icon-left color="light" (click)="loadUser()">\n		<ion-icon name="refresh"></ion-icon>\n		Relaod\n	</button>\n</ion-content>\n'/*ion-inline-end:"E:\Ionic\SakibShahriyarPathan\src\pages\login\login.html"*/,
        }),
